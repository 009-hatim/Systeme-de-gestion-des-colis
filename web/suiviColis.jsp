...
<html>
     <head>
        ...
        <title>HTrak - Suivi de Colis</title>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <form method="GET" action="suiviColis.jsp">
            ...
            <div class="card">
                ...
                <form method="POST" action="UpdateSuiviColis">
                    <input type="hidden" name="colisId" value="<%= request.getParameter("colisId")%>">
                    <div class="form-group">
                        <label>État</label>
